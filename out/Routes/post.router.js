...
router.get("/", function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                controller = new post_controller_1.default();
                return [4 /*yield*/, controller.getPosts()];
            case 1:
                response = _a.sent();
...
router.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                controller = new post_controller_1.default();
                return [4 /*yield*/, controller.createPost(req.body)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, res.send(response)];
        }
...
router.get("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                controller = new post_controller_1.default();
                return [4 /*yield*/, controller.getPost(req.params.id)];
            case 1:
                response = _a.sent();
                if (!response)
